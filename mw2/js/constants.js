...
const CITY_COORDINATES = {
    "none": { name: "不校正 (平太陽時)", lon: 120, tz: 8 },
    "hk": { name: "香港", lon: 114.15, tz: 8 },
    "tw_taipei": { name: "台灣 (台北)", lon: 121.56, tz: 8 },
    "tw_kaohsiung": { name: "台灣 (高雄)", lon: 120.31, tz: 8 },
    "mo": { name: "澳門", lon: 113.54, tz: 8 },
    "cn_beijing": { name: "北京", lon: 116.40, tz: 8 },
    "cn_shanghai": { name: "上海", lon: 121.47, tz: 8 },
    "cn_guangzhou": { name: "廣州", lon: 113.26, tz: 8 },
    "cn_chengdu": { name: "成都", lon: 104.06, tz: 8 },
    "sg": { name: "新加坡", lon: 103.81, tz: 8 },
    "my_kl": { name: "馬來西亞 (吉隆坡)", lon: 101.68, tz: 8 },
    "jp_tokyo": { name: "日本 (東京)", lon: 139.69, tz: 9 },
    "uk_london": { name: "英國 (倫敦)", lon: -0.12, tz: 0 },
    "us_ny": { name: "美國 (紐約)", lon: -74.00, tz: -5 },
    "us_la": { name: "美國 (洛杉磯)", lon: -118.24, tz: -8 }
};